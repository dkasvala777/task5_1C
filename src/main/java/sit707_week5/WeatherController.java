...
public class WeatherController {
	 ...
	 * @return
	 */
	public String persistTemperature(int hour, double temperature, String timestamp) {
	    System.out.println("Temperature: " + temperature + " of hour: " + hour + ", saved at " + timestamp);
